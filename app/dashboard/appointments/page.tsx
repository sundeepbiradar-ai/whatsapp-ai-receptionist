...
export default async function AppointmentsPage(): Promise<React.ReactElement> {
  ...
  try {
    [appointments, contacts] = await Promise.all([listAppointments(), listContacts()]);
  } catch (error) {
